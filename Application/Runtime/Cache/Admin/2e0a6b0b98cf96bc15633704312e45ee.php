            ...
            <form name="myform" id="myform" method="post">
                <div class="result-title">
                    <div class="result-list">
                        <a href="/ykj/index.php/Admin/Admin/add"><i class="icon-font"></i>新增栏目</a>
                ...
                <div class="result-content">
                    <table class="result-tab" width="100%">
                        ...
                        <?php if(is_array($adminres)): $i = 0; $__LIST__ = $adminres;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
                            ...
                            <td title="<?php echo ($vo["username"]); ?>">
                            	<a target="_blank" href="#" title="<?php echo ($vo["username"]); ?>"><?php echo ($vo["username"]); ?></a>
                            	<?php if($vo['username'] == 'admin'): ?><i class="require-red">*</i><?php endif; ?>
                            </td>
                            <td width="15%">
                                <a class="link-update" href="/ykj/index.php/Admin/Admin/edit/id/<?php echo ($vo["id"]); ?>">修改</a>&nbsp;&nbsp;
                                <a class="link-del" onclick="
                                	<?php if($vo['username'] == 'admin'): ?>alert('超级管理员不能被删除！') ;return false;
                                	<?php else: ?>
                                		return confirm('确定删除？')<?php endif; ?>" href="/ykj/index.php/Admin/Admin/del/id/<?php echo ($vo["id"]); ?>">删除</a>
                            </td>
