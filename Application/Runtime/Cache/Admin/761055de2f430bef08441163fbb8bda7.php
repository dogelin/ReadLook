                    ...
                    <table class="insert-tab" width="100%">
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
									<textarea cols="50" name="desc" ><?php echo ($artres["desc"]); ?></textarea>
                                </td>
                            </tr>
                            <tr>
                                <th>缩略图：</th>
                                <td>
                                	...
                                	<?php if($artres['pic'] != ''): ?><img src="/ykj<?php echo ($artres["pic"]); ?>" height="40px" width="40px"/>
                                		<?php else: ?>
                                		暂无缩略图<?php endif; ?>
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td>
                                	<select name="cateid" >
                                		<?php if(is_array($cateres)): $i = 0; $__LIST__ = $cateres;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><option <?php if($vo["id"] == $artres.cateid): ?>selected="selected"<?php endif; ?>value="<?php echo ($vo["id"]); ?>"><?php echo ($vo["catename"]); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
                                	</select>
                                </td>
                            </tr>
                            <tr>
