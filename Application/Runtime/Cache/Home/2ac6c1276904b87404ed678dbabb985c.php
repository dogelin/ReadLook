...
<script src="http://127.0.0.1/ykj/Application/Public/style/post.js"></script>
<title><?php echo ($artss["title"]); ?></title>		<script type="text/javascript">
...
<div class="meta">
	<h1 class="meta-tit"><?php echo ($artss["title"]); ?></h1>
	<p class="meta-info">分类：
		<a href="/ykj/index.php/Home/Cate/index/id/<?php echo ($vo["id"]); ?>"><?php echo ($caten); ?></a> 
		&nbsp;&nbsp; 发表日期：<?php echo ($artss["time"]); ?> &nbsp;&nbsp; </p>
</div>
...
<div class="entry">
	<p>
		<?php if($artss['pic']): ?><img class="aligncenter size-full wp-image-42806" width="600"  
	 src="/ykj<?php echo ($artss["pic"]); ?>" alt="<?php echo ($artss["title"]); ?>" 
	   />
	   <?php else: ?>
	   <img class="aligncenter size-full wp-image-42806" width="600"  
	 src="/ykj/Public/Uploads/2017-01-16/587cb94d1b5e5.jpg" alt="<?php echo ($artss["title"]); ?>"<?php endif; ?>
	</p>
	<?php echo htmlspecialchars_decode($artss['content']); ?>
</div>

<div>
	<?php if($pre): ?><strong>上一篇：</strong>
		<a class="prev-post icon-right" href="/ykj/index.php/Home/Article/index/id/<?php echo ($pre["id"]); ?>"><?php echo ($pre["title"]); ?></a>
	<?php else: ?>
		<strong>上一篇：</strong>没有了<?php endif; ?>
</div>

<div style="margin:10px 0;">
	<?php if($next): ?><strong>下一篇：</strong>
<a class="next-post" href="/ykj/index.php/Home/Article/index/id/<?php echo ($next["id"]); ?>">
<?php echo ($next["title"]); ?></a> 
<?php else: ?>
<strong>下一篇：</strong>没有了<?php endif; ?>
</div>
<!-- 分享代码 -->
